...
%     \caption{DualAttWaveNet's bidirectional attention mechanism. Both attention phase share the same parameter $Q, K$ and $V$. To decrease channel numbers, they are implemented as 1d-Convolution.}
...
\begin{table}[t]
    ...
    \resizebox{\linewidth}{!}{
        \begin{tabular}{lcccc}
            ...
            TrID (Signal)   &                              & 0.8321                       &                  & 1.0156                        \\
            TrID (Spectrum) & 0.7112                             & 0.6838                       & 0.7106                 & 1.0154                        \\
...
\begin{figure*}[tb]
    \centering
    \includegraphics[width=\linewidth]{confusion_new.pdf}
